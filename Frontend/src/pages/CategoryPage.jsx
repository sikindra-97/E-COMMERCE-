      ...
      Electronics: [
        {
          ...
          price: 799,
          images: [
            // ✅ Replaced BestBuy image with Pixabay for reliable loading
            'https://cdn.pixabay.com/photo/2016/11/18/14/52/headphones-1838763_960_720.jpg'
          ]
        },
        {
          _id: '2',
          ...
          {products.map(product => (
            ...
            >
              <img
                ...
                onError={(e) => {
                  e.target.src =
                    'https://via.placeholder.com/200x160.png?text=Image+Not+Found'
                }}
              />
